...
| Internal | Business information intended for internal organisational use. | Internal identifiers and operational metadata | Accessible to authorised employees |
...
Technical classifications may be detected automatically by governance tooling such as Microsoft Purview, while sensitivity requirements are determined according to organisational governance policies.
...
| Data Element | Data Classification | Personal Data | Sensitivity | Rationale |
|---|---|---:|---|---|
| invoice_id | Invoice Identifier | No | Internal | Operational identifier for an invoice |
...
| Data Element | Data Classification | Personal Data | Sensitivity | Rationale |
|---|---|---:|---|---|
| meter_id | Meter Identifier | Potentially | Internal | Identifies a meter and may become personal data when linked to a customer |
| customer_id | Customer Identifier | Yes | Confidential | Links consumption information to an identifiable customer |
| reading_date | Consumption Metadata | Potentially | Internal | Becomes customer-related information when combined with meter or customer identifiers |
...
A value marked as **Potentially** personal data may not identify an individual in isolation but can become personal data when linked with other identifiers or contextual information. For example, energy consumption data may become customer-related personal data when associated with a customer or meter identifier.
...
| Data Element | Data Classification | Personal Data | Sensitivity | Rationale |
|---|---|---:|---|---|
| tariff_id | Tariff Identifier | No | Internal | Internal identifier for a tariff |
...
In a Microsoft Purview Enterprise environment, this framework would be implemented using data scanning, classifications, catalogue metadata, and applicable sensitivity capabilities.
...
| customers.address | Address / personal data classification |
...
The classifications in this repository represent the intended governance design. Automated classification results were not generated because full Microsoft Purview Enterprise scanning was unavailable in the project environment.
