...
This operating model defines how data governance responsibilities, decision-making, data quality management, access control, and issue escalation work together across the demonstration energy data environment.
...
| Data Steward | Maintains definitions, monitors data quality, coordinates remediation, and supports governance processes |
...
Automated data quality checks evaluate governed datasets against approved rules and thresholds.
...
Failed quality checks are converted into governance issues and assigned to the relevant Data Steward.

Issues are prioritised according to severity and business impact.

### 5. Remediate

Data Stewards investigate root causes and coordinate corrective actions with relevant business or technical teams.

### 6. Validate

Automated checks are rerun after remediation to confirm that defined quality thresholds are met.
...
In a Microsoft Purview Enterprise environment, elements of this operating model could be supported through capabilities including:
